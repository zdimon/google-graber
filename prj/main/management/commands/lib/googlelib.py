...
from .utils import _get_search_url, get_html, get_html_from_dynamic_site
...
class GoogleResult(object):
    ...
    def __repr__(self):
        name = self.name
        description = self.description, 49
...
# PUBLIC
def search(query, page=1, lang='en', area='com', ncr=False, void=True, time_period=False, sort_by_date=False, first_page=0):
    ...
    url = _get_search_url(query, page, lang=lang, area=area, ncr=ncr, time_period=time_period, sort_by_date=sort_by_date)
